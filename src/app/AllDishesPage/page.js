  ...
  return (
    <div className="flex  bg-gray-100 gap-5 h-full w-[205px]">
      <div className="  flex-col bg-white px-5 py-9 flex  p-6 items-start gap-4 self-stretch rounded-xl">
        ...
        <Button
          variant="ghost"
          className="text-(--text-text-foreground,#09090B) font-inter text-sm font-medium leading-5"
        >
          <LayoutDashboardIcon className="w-[22px] h-[22px]" /> Food menu
        </Button>
        <Button
          variant="ghost"
          className="w-[121px] justify-start text-(--text-text-foreground,#09090B) font-inter text-sm font-medium leading-5"
        >
